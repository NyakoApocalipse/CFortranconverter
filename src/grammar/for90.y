...
%token /*_YY_DESCRIBER*/ YY_IMPLICIT YY_NONE YY_USE YY_PARAMETER YY_ENTRY YY_DIMENSION YY_ARRAYBUILDER_START YY_ARRAYBUILDER_END YY_INTENT YY_IN YY_OUT YY_INOUT YY_OPTIONAL YY_LEN YY_KIND YY_SINGR YY_FULLR YY_SINGI YY_FULLI YY_SINGL YY__SINGR YY__FULLR YY__SINGI YY__FULLI YY__SINGL YY_SAVE YY_ALLOCATABLE YY_TARGET YY_POINTER YY_FMT
