...
const std::map<std::string, std::vector<KeywordParamInfo>> sysfunc_args = {
    {"foropenfile",
     {{"unit", "int", ""},
      ...
      {"err", "forlabel", ""},
      {"file", "string", ""},
      {"status", "string", _WS("unknown")},
      {"access", "string", _WS("sequential")},
      {"form", "string", ""},
      {"recl", "int", ""},
      {"blank", "string", ""},
      {"position", "string", _WS("rewind")},
      {"action", "string", _WS("readwrite")},
      {"delim", "string", ""},
      {"pad", "string", ""}}},
    {"forclosefile",
     {{"unit", "int", ""}, {"iostat", "int", ""}, {"err", "forlabel", ""}}},
    {"forread",
     {{"unit", "int", ""}, {"fmt", "string", ""}, {"iostat", "int", ""}}},
    {"forwrite",
     {{"unit", "int", ""}, {"fmt", "string", ""}, {"iostat", "int", ""}}},
    {"forprint",
     {{"unit", "int", ""}, {"fmt", "string", ""}, {"iostat", "int", ""}}},
